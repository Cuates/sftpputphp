<?php
  /*
          File: sftp_put_class.php
       Created: 07/23/2020
       Updated: 07/26/2020
    Programmer: Cuates
    Updated By: Cuates
       Purpose: Class for all SFTP and Put interactions
  */

  // Include configuration file
  include ("sftp_put_config.php");
  ...
  class sftp_put_class extends sftp_put_config
  {
    ...
    public function sftp_put_class()
    {
    ...
    // Extract Data
    function extractData($param01, $param02, $param03)
    {
      // Query
      $query = "<Stored_Procedure_Name> @optionMode = :param01, @param02 = :param02";
      ...
      // Return single attribute from the database
      return $this->retrieveMultipleAttribute($param03, $query, $params, '1', '1', '<Database_Name>');
    }
